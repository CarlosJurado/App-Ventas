...
class FormularioRuta extends Component {
  ...
  handleGuardar = async (e) => {
    ...
    if (!turnoTrim) return toast.error("Elige un turno.");    
    ...
    try {
      await db.collection("rutas").add(rutas);
  ...
  render() {
    ...
    return (
      <div className="content-wrapper">
        <h3 align="center">Agregar ruta</h3>
