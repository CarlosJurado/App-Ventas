...
const Imprimir = () => {
  ...
  useEffect(() => {
    const obtenerDatos = async () => {
      const data = await fetch(`https://cloudfunctions.net/venta/api/venta/${id}`)
 ...
 function printData() {
  var style = '<style>';  
  style = style + 'table {width: 98%; font: 30px Hind;}';
...
{ usuario.email  ? (    <>
        ...
        <tr><td align="center" colspan="5"></td></tr>
        <tr><td align="center" colspan="5">Cliente: <b>{venta.cliente}</b></td></tr>
        <tr><td align="center" colspan="5"></td></tr>        
        <tr><td align="center" colspan="5">{moment(venta.fecha).format('LL')}</td></tr>
        <tr><td align="center" colspan="5">Vendedor: {venta.nombre}</td></tr>
        <tr><td align="center" colspan="5"></td></tr>
        <tr><td align="center" colspan="5"></td></tr>        
        ...
        <>  <tr key={item.id}>
            ...
            <td align="center" colspan="1">$ {formatNum(item.precio)}</td>
            <td align="center" colspan="1">$ {formatNum(item.subtotal)}</td>
          </tr>
...
<th align="center" colspan="4">TOTAL: $ {formatNum(venta.total)}</th>
<th></th>
<tr><td align="center" colspan="5"><b>Gracias por su compra</b></td></tr>
      </table>
      <br/>      
